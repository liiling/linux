...
struct stats_fs_value stats_fs_vcpu_entries[] = {
	VCPU_STAT("wait", "wait", wait_exits),
	VCPU_STAT("cache", "cache", cache_exits),
	VCPU_STAT("signal", "signal", signal_exits),
	VCPU_STAT("interrupt", "interrupt", int_exits),
	VCPU_STAT("cop_unusable", "cop_unusable", cop_unusable_exits),
	VCPU_STAT("tlbmod", "tlbmod", tlbmod_exits),
	VCPU_STAT("tlbmiss_ld", "tlbmiss_ld", tlbmiss_ld_exits),
	VCPU_STAT("tlbmiss_st", "tlbmiss_st", tlbmiss_st_exits),
	VCPU_STAT("addrerr_st", "addrerr_st", addrerr_st_exits),
	VCPU_STAT("addrerr_ld", "addrerr_ld", addrerr_ld_exits),
	VCPU_STAT("syscall", "syscall", syscall_exits),
	VCPU_STAT("resvd_inst", "resvd_inst", resvd_inst_exits),
	VCPU_STAT("break_inst", "break_inst", break_inst_exits),
	VCPU_STAT("trap_inst", "trap_inst", trap_inst_exits),
	VCPU_STAT("msa_fpe", "msa_fpe", msa_fpe_exits),
	VCPU_STAT("fpe", "fpe", fpe_exits),
	VCPU_STAT("msa_disabled", "msa_disabled", msa_disabled_exits),
	VCPU_STAT("flush_dcache", "flush_dcache", flush_dcache_exits),
#ifdef CONFIG_KVM_MIPS_VZ
	VCPU_STAT("vz_gpsi", "vz_gpsi", vz_gpsi_exits),
	VCPU_STAT("vz_gsfc", "vz_gsfc", vz_gsfc_exits),
	VCPU_STAT("vz_hc", "vz_hc", vz_hc_exits),
	VCPU_STAT("vz_grr", "vz_grr", vz_grr_exits),
	VCPU_STAT("vz_gva", "vz_gva", vz_gva_exits),
	VCPU_STAT("vz_ghfc", "vz_ghfc", vz_ghfc_exits),
	VCPU_STAT("vz_gpa", "vz_gpa", vz_gpa_exits),
	VCPU_STAT("vz_resvd", "vz_resvd", vz_resvd_exits),
#endif
