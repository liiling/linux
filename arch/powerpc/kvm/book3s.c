...
struct stats_fs_value stats_fs_vcpu_entries[] = {
	VCPU_STAT("exits", "exits", sum_exits),
	...
	VCPU_STAT("queue_intr", "queue_intr", queue_intr),
	VCPU_STAT("halt_poll_success_ns", "halt_poll_success_ns", halt_poll_success_ns),
	VCPU_STAT("halt_poll_fail_ns", "halt_poll_fail_ns", halt_poll_fail_ns),
	VCPU_STAT("halt_wait_ns", "halt_wait_ns", halt_wait_ns),
	...
	VCPU_STAT("halt_successful_wait", "halt_successful_wait", halt_successful_wait),
	VCPU_STAT("halt_poll_invalid", "halt_poll_invalid", halt_poll_invalid),
	VCPU_STAT("halt_wakeup", "halt_wakeup", halt_wakeup),
	VCPU_STAT("pf_storage", "pf_storage", pf_storage),
	VCPU_STAT("sp_storage", "sp_storage", sp_storage),
	VCPU_STAT("pf_instruc", "pf_instruc", pf_instruc),
	VCPU_STAT("sp_instruc", "sp_instruc", sp_instruc),
	VCPU_STAT("ld", "ld", ld),
	VCPU_STAT("ld_slow", "ld_slow", ld_slow),
	VCPU_STAT("st", "st", st),
	VCPU_STAT("st_slow", "st_slow", st_slow),
	VCPU_STAT("pthru_all", "pthru_all", pthru_all),
	VCPU_STAT("pthru_host", "pthru_host", pthru_host),
	VCPU_STAT("pthru_bad_aff", "pthru_bad_aff", pthru_bad_aff),
	{ NULL }
};

struct stats_fs_value stats_fs_vm_entries[] = {
	VM_STAT("largepages_2M", "largepages_2M", num_2M_pages, .mode = 0444),
	VM_STAT("largepages_1G", "largepages_1G", num_1G_pages, .mode = 0444),
	{ NULL }
};
